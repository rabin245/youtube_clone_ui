          ...
          <div className="details">
            <div className="title font-bold text-sm h-10 cursor-pointer">
              <p className="line-clamp-2">
                Extremely long title that will be clipped to 2 lines and then
                the rest will be hidden with ellipsis and overflow-y-hidden
                class on the Extremely long title that will be clipped to 2
                lines and then the rest will be hidden with ellipsis and
                overflow-y-hidden class on the
              </p>
            </div>
